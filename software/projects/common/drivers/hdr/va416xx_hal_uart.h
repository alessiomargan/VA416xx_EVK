...
#define HAL_UART_VERSION (0x00020005UL) // 2.05
...
#define UART0_BANK    (0UL)
#define UART1_BANK    (1UL)
#define UART2_BANK    (2UL)
#define HAL_NUM_UARTS (3UL)

/** Common UART config macros */
#define UART_CFG_230K_8N1 (stc_uart_cfg_t){.baudRate = 230400, \
                                           .irq = en_uart_irq_rx, \
                                           .wordSize = 8, \
                                           .parity = en_uart_parity_none, \
                                           .stopBits = 1, \
                                           false}

#define UART_CFG_115K_8N1 (stc_uart_cfg_t){.baudRate = 115200, \
                                           .irq = en_uart_irq_rx, \
                                           .wordSize = 8, \
                                           .parity = en_uart_parity_none, \
                                           .stopBits = 1, \
...
#define UART_CFG_9600_8N1 (stc_uart_cfg_t){.baudRate = 9600, \
                                           .irq = en_uart_irq_rx, \
                                           .wordSize = 8, \
                                           .parity = en_uart_parity_none, \
                                           .stopBits = 1, \
...
hal_status_t HAL_Uart_DeInit  (VOR_UART_Type* const uart); // disables uart to save power
...
hal_status_t HAL_Uart_RxHndlr (void); // RX fifo handler, polling (for all initialized uarts w/o interrupt)
