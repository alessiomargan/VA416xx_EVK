...
// Removes HAL_Init() setting up SysTick, and SysTick_Handler() in va416xx_hal.c
// Define this when using FreeRTOS
#define __HAL_DISABLE_SYSTICK

/* Internal in milliseconds between SysTick interrupts (defines how SysTick is init)*/
#define SYSTICK_INTERVAL_MS (1)

// if defined, output detailed PLL config information
//#define __HAL_PLL_DEBUG_LOG

// remove SPI interrupts from build if not using
