...
/*
 * VOR CAN0 Message Buffers used:
 * - CMB0:  Rx RTR ID 0x100
 * - CMB1:  Tx RTR Response ID 0x100
 * - CMB2:  Rx RTR ID 0x101
 * - CMB3:  Tx RTR Response ID 0x101
 * - CMB4:  Rx RTR ID 0x102
 * - CMB5:  Tx RTR Response ID 0x102
 * - CMB6:  Rx RTR ID 0x103
 * - CMB7:  Tx RTR Response ID 0x103
 * - CMB8:  Rx RTR ID 0x104
 * - CMB9:  Tx RTR Response ID 0x104
 * - CMB10: Rx RTR ID 0x105
 * - CMB11: Tx RTR Response ID 0x105
 * - CMB12: Tx standard ID messages AFE data responses
 * - CMB13: Tx standard ID messages Error responses
 * - CMB14: Rx standard ID messages (catch-all)
*/
static hal_can_id11_t can0_rtr_id_0 = 0x100;
// CMB0 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_0 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB0;
// CMB1 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_1 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB1;

static hal_can_id11_t can0_rtr_id_1 = 0x101;
// CMB2 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_2 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB2;
// CMB3 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_3 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB3;

static hal_can_id11_t can0_rtr_id_2 = 0x102;
// CMB4 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_4 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB4;
// CMB5 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_5 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB5;

static hal_can_id11_t can0_rtr_id_3 = 0x103;
// CMB6 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_6 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB6;
// CMB7 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_7 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB7;

static hal_can_id11_t can0_rtr_id_4 = 0x104;
// CMB8 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_8 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB8;
// CMB9 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_9 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB9;

static hal_can_id11_t can0_rtr_id_5 = 0x105;
// CMB10 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can0_cmb_10 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB10;
// CMB11 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can0_cmb_11 = (volatile can_cmb_t*)&VOR_CAN0->CNSTAT_CMB11;

// CMB12 Tx msg buffer for standard ID message
static can_cmb_t * const can0_cmb_12 = (can_cmb_t*)&VOR_CAN0->CNSTAT_CMB12;
// CMB13 Tx msg buffer for standard ID message
static can_cmb_t * const can0_cmb_13 = (can_cmb_t*)&VOR_CAN0->CNSTAT_CMB13;
// CMB14 Rx msg buffer for catch-all any standard ID message
static can_cmb_t * const can0_cmb_14 = (can_cmb_t*)&VOR_CAN0->CNSTAT_CMB14;

// Array of buffer pointers for RTR responses
volatile can_cmb_t * const cmb_RTR_resp[] = {
    can0_cmb_1, can0_cmb_3, can0_cmb_5, can0_cmb_7, can0_cmb_9, can0_cmb_11};

/*
 * VOR CAN1 Message Buffers used:
 * - CMB0:  Rx RTR ID 0x200
 * - CMB1:  Tx RTR Response ID 0x200
 * - CMB2:  Rx RTR ID 0x201
 * - CMB3:  Tx RTR Response ID 0x201
 * - CMB4:  Rx RTR ID 0x202
 * - CMB5:  Tx RTR Response ID 0x202
 * - CMB6:  Rx RTR ID 0x203
 * - CMB7:  Tx RTR Response ID 0x203
 * - CMB8:  Rx RTR ID 0x204
 * - CMB9:  Tx RTR Response ID 0x204
 * - CMB10: Rx RTR ID 0x205
 * - CMB11: Tx RTR Response ID 0x205
 * - CMB12: Rx RTR ID 0x206
 * - CMB13: Tx RTR Response ID 0x206
 * - CMB14: Rx Extended ID messages (catch-all)
*/
static hal_can_id11_t can1_rtr_id_0 = 0x200;
// CMB0 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_0 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB0;
// CMB1 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_1 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB1;

static hal_can_id11_t can1_rtr_id_1 = 0x201;
// CMB2 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_2 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB2;
// CMB3 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_3 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB3;

static hal_can_id11_t can1_rtr_id_2 = 0x202;
// CMB4 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_4 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB4;
// CMB5 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_5 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB5;

static hal_can_id11_t can1_rtr_id_3 = 0x203;
// CMB6 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_6 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB6;
// CMB7 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_7 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB7;

static hal_can_id11_t can1_rtr_id_4 = 0x204;
// CMB8 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_8 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB8;
// CMB9 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_9 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB9;

static hal_can_id11_t can1_rtr_id_5 = 0x205;
// CMB10 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_10 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB10;
// CMB11 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_11 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB11;

static hal_can_id11_t can1_rtr_id_6 = 0x206;
// CMB12 Rx msg buffer Remote Transmission Request
static volatile can_cmb_t * const can1_cmb_12 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB12;
// CMB13 TX msg buffer Remote Transmission Response
static volatile can_cmb_t * const can1_cmb_13 = (volatile can_cmb_t*)&VOR_CAN1->CNSTAT_CMB13;

// CMB14 Rx msg buffer for catch-all any standard ID message
static can_cmb_t * const can1_cmb_14 = (can_cmb_t*)&VOR_CAN1->CNSTAT_CMB14;

// Array of buffer pointers for RTR responses
volatile can_cmb_t * const can1_cmb_RTR_resp[] = {
    can1_cmb_1, can1_cmb_3, can1_cmb_5, can1_cmb_7, can1_cmb_9, can1_cmb_11, can1_cmb_13};
...
void ConfigureCAN0(void)
{
    ...
    HAL_Can_ConfigCMB_Rx(0x0, en_can_cmb_msgtype_STD11, can0_cmb_14);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_0, can0_cmb_1, can0_rtr_id_0);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_2, can0_cmb_3, can0_rtr_id_1);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_4, can0_cmb_5, can0_rtr_id_2);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_6, can0_cmb_7, can0_rtr_id_3);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_8, can0_cmb_9, can0_rtr_id_4);
    ...
    HAL_Can_ConfigCMBs_RTR(can0_cmb_10, can0_cmb_11, can0_rtr_id_5);

}

void ConfigureCAN1(void)
{
    HAL_Can_Enable(VOR_CAN1);
    /* Initialize CAN1 module with configuration and enable NVIC interrupt for CAN1 */
    HAL_Can_Setup(VOR_CAN1, &canConfig, CAN1_IRQn);

    /* No interrupts are enabled for CAN1 (VOR_CAN1->CIEN = 0x4000 was set but CMB14 is not configured) */
    VOR_CAN1->CIEN = 0x4000; // bit 14 (0x4000)  

    VOR_CAN1->GMSKX = 0;
    VOR_CAN1->GMSKB = 0x0010;
    VOR_CAN1->BMSKX = 0;
    VOR_CAN1->BMSKB = 0;
    /* Clear all CAN message buffers */
    HAL_Can_ClearAllBufferStatus(VOR_CAN1);
    /* Configure Rx msg 14 as a catch-all for any extended ID message */
    //HAL_Can_ConfigCMB_Rx(0x0, en_can_cmb_msgtype_EXT29, can1_cmb_14);
    
    /* Configure rx CMB0 for Remote Transmission Request - standard frame */
    /* Configure tx CMB1 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_0, can1_cmb_1, can1_rtr_id_0);
    /* Configure rx CMB2 for Remote Transmission Request - standard frame */
    /* Configure tx CMB3 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_2, can1_cmb_3, can1_rtr_id_1);
    /* Configure rx CMB4 for Remote Transmission Request - standard frame */
    /* Configure tx CMB5 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_4, can1_cmb_5, can1_rtr_id_2);
    /* Configure rx CMB6 for Remote Transmission Request - standard frame */
    /* Configure tx CMB7 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_6, can1_cmb_7, can1_rtr_id_3);
    /* Configure rx CMB8 for Remote Transmission Request - standard frame */
    /* Configure tx CMB9 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_8, can1_cmb_9, can1_rtr_id_4);
    /* Configure rx CMB10 for Remote Transmission Request - standard frame */
    /* Configure tx CMB11 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_10, can1_cmb_11, can1_rtr_id_5);
    /* Configure rx CMB12 for Remote Transmission Request - standard frame */
    /* Configure tx CMB13 for Remote Transmission Request Response - standard frame */
    HAL_Can_ConfigCMBs_RTR(can1_cmb_12, can1_cmb_13, can1_rtr_id_6);
...
void CAN0_IRQHandler(void)
{
    ...
    */
    ...
    if (irq_pending & 0x4000) {
        ...
        if (HAL_Can_getCanPktIRQ(can0_cmb_14, &rxPkt) != 0) {
            return;
        }

        /* Filter out IDs 0x200-0x206 (reserved for CAN1) */
        if (rxPkt.id >= 0x200 && rxPkt.id <= 0x206) {
            can0_cmb_14->CNSTAT = en_can_cmb_cnstat_st_RX_READY;
            return;
        }
        ...
        case 0x123:
            ...
            HAL_Can_sendCanPkt(can0_cmb_12, &respPkt);
            break;
        ...
        default:
            respPkt.id = 0x0EE;
            respPkt.dataLengthBytes = 8;
            respPkt.txPriorityCode = 0;   /* Highest priority */
            respPkt.msgType = en_can_cmb_msgtype_STD11;
            respPkt.data16[0] = 0xE0E0;
            respPkt.data16[1] = 0xE0E0;
            respPkt.data16[2] = 0xE0E0;
            respPkt.data16[3] = rxPkt.id;
            /* Send the response using a free transmit buffer */
            HAL_Can_sendCanPkt(can0_cmb_13, &respPkt);
            break;
        }
 ...
 * 
 * @note CAN1 uses automatic RTR responses via hardware (CMB0-CMB13)
 *       No software intervention needed - hardware handles RTR automatically
 *       CMB14 is not enabled, so this handler remains empty
 */
void CAN1_IRQHandler(void)
{
    /* All CAN1 message buffers (CMB0-CMB13) are configured for automatic 
       RTR response. The hardware automatically responds to RTR requests
       without requiring software intervention in this interrupt handler. */
    
    // Currently no interrupts enabled for CAN1
    // If needed in the future, add handler code here
}